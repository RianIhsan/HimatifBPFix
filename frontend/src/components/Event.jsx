...
import Discuss from "../assets/4.png";
import Discuss2 from "../assets/7.png";
import Discuss3 from "../assets/5.png";
          ...
          <div className="w-[80vw] h-[80vh]">
            <div className="h-[17vh] flex">
              <div className="w-[49%] flex flex-col items-end justify-center pr-5">
                <h3 className="text-semibold text-[1]">Survey Maba</h3>
                <h3 className="text-[#5BCDA4] text-semibold text-[0.8rem]">
                  11 Februari 2023
                </h3>
              </div>
              <div className="flex items-end w-[2%]">
                <div className="bg-[#020181] w-[100%] h-[100%] rounded-t"></div>
              </div>
              <div className="flex items-center w-[12%]">
                <div className="bg-[#020181] w-[100%] h-[0.7vh] rounded-r"></div>
              </div>
            ...
            <div className="h-[17vh] flex">
              ...
              <div className="flex items-center w-[12%]">
                <div className="bg-[#020181] w-[100%] h-[0.7vh] rounded-l"></div>
              </div>
              <div className="flex items-end w-[2%]">
                <div className="bg-[#020181] w-[100%] h-[100%]"></div>
              </div>
              <div className="w-[49%] flex flex-col justify-center pl-5">
                <h3 className="text-semibold text-[1rem]">Sharing Alumni</h3>
                <h3 className="text-[#5BCDA4] text-semibold text-[0.8rem]">
                  18 Februari 2023
                </h3>
              </div>
            ...
            <div className="h-[17vh] flex">
              <div className="w-[49%] flex flex-col items-end justify-center pr-5">
                <h3 className="text-semibold text-[1rem]">
                  Rapat dan Evaluasi
                </h3>
                <h3 className="text-[#5BCDA4] text-semibold text-[0.8rem]">
                  1 Maret 2023
            ...
            <div className="h-[17vh] flex">
              ...
              <div className="flex items-end w-[2%]">
                <div className="bg-[#020181] w-[100%] h-[100%] rounded-b"></div>
              </div>
              <div className="w-[49%] flex flex-col justify-center pl-5">
                <h3 className="text-semibold text-[1rem]">
        ...
        <div className="w-[89vw] h-[490px] flex justify-center max-[500px]:hidden ">
          <div className="w-[27%] h-[430px]">
            ...
            <div className="h-[75px] flex justify-center flex-col items-center">
              <h3 className="text-semibold text-[1.2rem]">Survey maba</h3>
          ...
          <div className="w-[27%] h-[430px]">
            <div className="h-[210px] flex items-end justify-center">
              <div className="h-[75px] flex justify-center flex-col items-center">
                <h3 className="text-semibold text-[1.2rem]">Sharing Alumni</h3>
                <h3 className="text-[#5BCDA4] text-semibold text-[1rem]">
                  18 Februari 2023
                </h3>
              </div>
